...
public class SupperFragment extends BaseFragment{
    ...
    protected void handleUI(Message msg) {
        if (msg.what == INetWorkAction.HOME_BANNER_SUPPER_FRAGMENT) {
    ...
    private void initData() {
        mBannerFragmentController.sendAsynchronization(INetWorkAction.HOME_BANNER_SUPPER_FRAGMENT);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        initController();
        initData();
        View view = View.inflate(getContext(), R.layout.home_banner_supper_layout, null);
        initView(view);
        return view;
    }

    private void initView(View view) {
        mHomeOptimumBreakfastFragment = (RecyclerView) view.findViewById(R.id.home_optimum_supper_fragment);
