...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerAdapter(Context context, List<FindListBean.DataBeanX.DataBean> data) {
        this.mDatas = data;
    ...
    private void setContextImg(ItemViewHolder holder, FindListBean.DataBeanX.DataBean dataBean) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(0, 200, 1);
