...
public class NewsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<NewestBean.DataBeanX.DataBean> mDatas;
    private NewsRecyclerAdapter.OnItemClickListener onItemClickListener;
    private final Context mContext;

    public NewsRecyclerAdapter(Context context, List<NewestBean.DataBeanX.DataBean> data) {
        this.mDatas = data;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
            ...
            NewestBean.DataBeanX.DataBean dataBean = mDatas.get(position+1);
            //昵称
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                if(onItemClickListener != null) {
                    ...
                    onItemClickListener.onItemClick(itemholder.itemView, pos+1);
                }
            }
        });
    ...
    private void setContextImg(ItemViewHolder holder, NewestBean.DataBeanX.DataBean dataBean) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if(size==1) {
                ...
                layoutParams = new LinearLayout.LayoutParams(300, ViewGroup.LayoutParams.WRAP_CONTENT);
            }
    ...
    private void setLevel(ItemViewHolder holder, NewestBean.DataBeanX.DataBean dataBean) {
    ...
    public void loadMore(List<NewestBean.DataBeanX.DataBean> addData) {
